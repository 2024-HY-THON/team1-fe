                        ...
                        <div className={"shop-product-container-wrapper"}>
                            ...
                            <div className={"shop-category-container"}>
                                <div className={"shop-category-area"}>
                                    <button className={`shop-category ${activeCategory === 0 ? "active" : "inactive"}`}
                                    ...
                                    <button className={`shop-category ${activeCategory === 1 ? "active" : "inactive"}`}
                                    ...
                                    <button className={`shop-category ${activeCategory === 2 ? "active" : "inactive"}`}
